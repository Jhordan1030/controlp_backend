...
try {
    ...
    // Auditoria (Relaciones polimórficas opcionales o sin relación estricta para no romper integridad si se borran usuarios)
    // No definimos foreignKey directa para permitir que el log persista aunque se borre el usuario
...
const checkTables = async () => {
    try {
        ...
        const tables = ['universidades', 'periodos', 'estudiantes', 'administradores', 'registros_horas', 'auditoria'];
        const results = [];
